...
#     # return dict(
#     #     p_hi = Constants.probability,
#     #     p_lo = 1 - Constants.probability,
...
class Decision(Page):
    ...
    def vars_for_template(self):
        ...
        return {
            ...
            'total':       total,
            'progress':    progress,
            'time_payoff': self.participant.vars['time_payoffs'][page - 1],
...
class Results(Page):
    ...
    def vars_for_template(self):
        ...
        sure_payoff = self.player.participant.vars['time_payoffs'][choice_to_pay - 1]
